...
namespace CSHARPMVC.Controllers
{
    ...
    {
        private bengkelEntities db = new bengkelEntities();
        ...
        public ActionResult Create([Bind(Include = "id,nama,alamat,contact")] tblCustomer tblCustomer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "id,nama,alamat,contact")] tblCustomer tblCustomer)
        {
            if (ModelState.IsValid)
            {
